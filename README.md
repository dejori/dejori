...
- Last paper read: <!-- PAPER:START -->*LINEARRAG: LINEAR GRAPH RETRIEVAL AUG-MENTED GENERATION ON LARGE-SCALE CORPORA* by Zhuang, Chen, Xiao, Zhou, Zhang, Chen, Zhang, Huang [[ref]](https://arxiv.org/abs/2510.10114v4)<!-- PAPER:END --> ([my paper-trail](https://github.com/dejori/my-paper-trail))
