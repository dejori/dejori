...
- Last paper read: <!-- PAPER:START -->*Crashing Waves vs. Rising Tides: Preliminary Findings on AI Automation from Thousands of Worker Evaluations of Labor Market Tasks* by Mertens, Kuzee, Futuretech, Harris, Lyu, Li, Rosenfeld, Anto, Fleming, Thompson (2026) [[ref]](https://arxiv.org/abs/2604.01363)<!-- PAPER:END --> ([my paper-trail](https://github.com/dejori/my-paper-trail))
