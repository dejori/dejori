...
- Last paper read: <!-- PAPER:START -->*AutoMedPrompt: A New Framework for Optimizing LLM Medical Prompts Using Textual Gradients* by Wu, Koo, Scalzo, Kurtz [[ref]](https://arxiv.org/abs/2502.15944v1)<!-- PAPER:END --> ([my paper-trail](https://github.com/dejori/my-paper-trail))
