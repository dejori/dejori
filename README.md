...
- Last paper read: <!-- PAPER:START -->*LinearRAG: Linear Graph Retrieval Augmented Generation on Large-scale Corpora* by Zhuang, Chen, Xiao, Zhou, Zhang, Chen, Zhang, Huang (2025) [[ref]](https://arxiv.org/abs/2510.10114)<!-- PAPER:END --> ([my paper-trail](https://github.com/dejori/my-paper-trail))
