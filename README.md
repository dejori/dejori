...
- Last paper read: <!-- PAPER:START -->*AutoSaddler: Automatic Harness Optimization with Durable Updates from Agent Execution Traces* by Park, Kim, Tan, Zhang, Han, Gao, Park, Yao, Fu, Nallipogu, Lin, Rajmohan, Zhang (2026)<!-- PAPER:END --> ([my paper-trail](https://github.com/dejori/my-paper-trail))
